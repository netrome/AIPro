...
In Figure \ref{fig:scale} the result for the  
...
\begin{figure}[H]
  \centering
      \includegraphics[width=\textwidth]{Time_to_goal_vs_agents_50x50_map_Easy=05.eps}
  \caption{Agent performance for the scalable algorithms as a function of number
    of agents.}
  \label{fig:scale}
\end{figure}
